...
the full list of block codes is here: (excluding some beams)
https://tomtom4500.lovestoblog.com/BuildLogic/Paste/TableItems.json
#### BEAMS
beams use weird characters for block codes.
(the other beams can be found on the list)
...
[]
### Encoded Color
its encoded the same way as positon. like a grid index. but use r g b instead of x y z
### Material Code
[]
